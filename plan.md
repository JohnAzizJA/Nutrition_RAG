...
* [ ] **Nutrition Enhancement:** Support alternative food units (grams, pieces, ml).
* [ ] **Nutrition Enhancement:** Implement Pre-set Meals feature for one-tap logging of recurring meals.
